...
export default function App() {
  ...
  return (
    <div className="flex flex-col pt-28 px-60 mx-80">
      ...
      <div className="z-30 bg-white shadow-black shadow-lg rounded px-8 pt-6 pb-8 mb-4">
        <div className="flex font-bold mb-6 bg-red-200 rounded p-2 shadow-sm shadow-black">
          <span className="mr-2 mt-1 text-7xl"><BsCalculator /></span>
          {' '}
          <h1 className="text-3xl pt-5">GROSS & NET INCOME CALCULATOR</h1>
        </div>
      ...
      <div className="flex justify-center">
        {calculated ? (
          <button
            className="absolute top-2/3 mt-28 z-50 text-2xl font-bold transition-all hover:scale-105
